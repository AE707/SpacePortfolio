    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col items-center justify-center w-[95%] gap-4">
                {/* Row 1: Game & Embedded Systems | Frontend & Web Development */}
                ...
                {/* Row 2: Dev Tools | Mobile & Backend */}
                <div className="w-full flex flex-col lg:flex-row items-center justify-between gap-4">
                    <div className="w-full lg:w-1/2 h-full">
                        <InView triggerOnce={false}>
                            {({ inView, ref }) => (
                ...
                {/* Row 3: AI & Automation (full width or centered) */}
                        ...
                        <InView triggerOnce={false}>
                            {({ inView, ref }) => (
                                ...
                                >
                                    ...
                                    <br />
                                    <div className="flex flex-row justify-around flex-wrap my-4 gap-5 items-center">
                                        {/* Make sure to import AI_Automation array from constants or replace with correct array */}
                                        {Automation.map((image, index) => (
                                            <SkillDataProvider
                                                key={index}
                                                src={image.Image}
                                                width={image.width}
